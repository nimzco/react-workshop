...
function Avatar$1(_ref) {
    ...
    var className = classNames(styles.Avatar, styles[variationName('style', styleClass(nameString))], source && styles.hasImage, size && styles[variationName('size', size)]);
    var content = null;
    if (finalSource) {
...
function Icon$1(_ref) {
    ...
    var className = classNames(styles$1.Icon, color && styles$1[variationName('color', color)], backdrop && styles$1.hasBackdrop);
...
function Button$1(_ref) {
    ...
    var className = classNames$1(styles$2.Button, primary && styles$2.primary, outline && styles$2.outline, destructive && styles$2.destructive, disabled && styles$2.disabled, plain && styles$2.plain, size && styles$2[variationName$1('size', size)], fullWidth && styles$2.fullWidth, icon && children == null && styles$2.iconOnly);
...
var Item = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$3.Item, focused && styles$3['Item-focused'], button.props.plain && styles$3['Item-plain']);
            return createElement(
                'div',
...
function ButtonGroup$1(_ref) {
    ...
    var className = classNames(styles$3.ButtonGroup, segmented && styles$3.segmented);
...
function Item$2(_ref) {
    ...
    var className = classNames(styles$4.Item, fill && styles$4['Item-fill']);
    return createElement(
        'div',
        { className: className },
        children
...
var Stack$1 = function (_React$PureComponent) {
    ...
    _createClass(Stack, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$4.Stack, vertical && styles$4.vertical, spacing && styles$4[variationName('spacing', spacing)], distribution && styles$4[variationName('distribution', distribution)], alignment && styles$4[variationName('alignment', alignment)]);
...
function Section(_ref) {
    ...
    var className = classNames(styles$6.Section, subdued && styles$6['Section-subdued']);
    return createElement(
        'div',
        { className: className },
        headerContent,
...
var Card$1 = function (_React$PureComponent) {
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$6.Card, subdued && styles$6.subdued);
...
function TextStyle$1(_ref) {
    ...
    var className = classNames(variation && styles$9[variationName('variation', variation)]);
    return createElement(
        'span',
        { className: className },
        children
...
function renderSection(section, hasMultipleSections, index) {
    ...
    var actionMarkup = section.items.map(function (_a) {
        ...
        return createElement(Item$3, Object.assign({ key: content, content: content }, item));
    });
...
function Badge$1(_ref) {
    ...
    var className = classNames(styles$13.Badge, status && styles$13[variationName('status', status)], progress && styles$13[variationName('progress', progress)]);
...
function Banner$1(_ref) {
    ...
    var className = classNames(styles$14.Banner, status && styles$14[variationName('status', status)], onDismiss && styles$14.hasDismiss);
    var id = uniqueID();
...
function Choice$1(_ref) {
    ...
    var className = classNames(styles$18.Choice, labelHidden && styles$18.labelHidden);
...
function Checkbox$1(_ref) {
    ...
    var className = classNames(styles$19.Checkbox, error && styles$19.error);
    return createElement(
        Choice$1,
...
function ChoiceList$1(_ref) {
    ...
    var className = classNames(styles$21.ChoiceList, titleHidden && styles$21.titleHidden);
    ...
    var choicesMarkup = choices.map(function (choice) {
        ...
        return createElement(
            'li',
            { key: key },
            createElement(ControlComponent, { name: finalName, value: value, label: label, checked: choiceIsSelected(choice, selected), onChange: handleChange })
        );
    });
    return createElement(
        'fieldset',
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = classNames(styles$22.Collapsible, open && styles$22.open, animating && styles$22.animating);
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return createElement(
                ...
                createElement('div', { className: styles$23.ColorLayer, style: { background: background } }),
                createElement(Slidable, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
            );
        }
    }, {
...
var Day = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$24.Day, selected && styles$24['Day-selected'], disabled && styles$24['Day-disabled'], (inRange || inHoveringRange) && !disabled && styles$24['Day-inRange']);
...
function Month(_ref) {
    ...
    var weekdays = WEEKDAYS.map(function (weekday) {
        return createElement(Weekday, { key: weekday, title: abbreviationForWeekday(weekday), label: weekday });
    });
...
function DisplayText$1(_ref) {
    ...
    var className = classNames(styles$26.DisplayText, size && styles$26[variationName('size', size)]);
    return createElement(
        Element,
        { className: className },
        children
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = classNames(styles$27.EmptyState, imageContained && styles$27.imageContained);
      var imageMarkup = largeImage ? createElement(Image$1, { alt: '', role: 'presentation', className: styles$27.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : createElement(Image$1, { role: 'presentation', alt: '', className: styles$27.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return createElement(
        'div',
        { className: className },
...
function Group(_ref) {
    ...
    var className = classNames(condensed && styles$29.condensed);
    ...
    var itemsMarkup = Children.map(children, function (child) {
        return wrapWithComponent(child, Item$4);
    });
    return createElement(
        'div',
...
function wrapChildren(child, index) {
    ...
    return wrapWithComponent(child, Item$4, { key: index });
}
...
function Label$1(_ref) {
    ...
    var className = classNames(styles$31.Label, hidden && styles$31.hidden);
...
function Section$1(_ref) {
    ...
    var className = classNames(styles$32.Section, secondary && styles$32['Section-secondary']);
    return createElement(
        'div',
        { className: className },
        children
...
var ContentList = function (_React$PureComponent) {
    ...
    _createClass(ContentList, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$34.List, type && styles$34[variationName('type', type)]);
...
function Pagination$1(_ref) {
  ...
  var className = classNames$1(styles$36.Pagination, plain && styles$36.plain);
...
function Header$1(_ref) {
    ...
    var className = classNames(styles$37.Header, pagination && styles$37['Header-hasPagination'], breadcrumbs && breadcrumbs.length && styles$37['Header-hasBreadcrumbs']);
    var breadcrumbMarkup = breadcrumbs != null && breadcrumbs.length > 0 ? createElement(Breadcrumbs$1, { breadcrumbs: breadcrumbs }) : null;
    ...
    var actionsMarkup = primaryActionMarkup || secondaryActionsMarkup ? createElement(
        'div',
...
function secondaryActionsFrom(actions) {
    return actions.map(function (_ref2) {
        ...
        var contentMarkup = icon ? createElement(
            'span',
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$37.Page, fullWidth && styles$37.fullWidth);
            var headerMarkup = this.context.easdk ? null : createElement(Header$1, rest);
            return createElement(
                'div',
                { className: className },
                headerMarkup,
...
var Scrollable$1 = function (_React$Component) {
    ...
    _createClass(Scrollable, [{
        ...
        value: function render() {
            ...
            var finalClassName = classNames(className, styles$39.Scrollable, vertical && styles$39.vertical, horizontal && styles$39.horizontal, topShadow && styles$39.hasTopShadow, bottomShadow && styles$39.hasBottomShadow);
            return createElement(
                'div',
        ...
        value: function forNode(node) {
            return closest(node, scrollable.selector) || document.body;
        }
    }]);
    ...
    _createClass(PositionedOverlay, [{
        ...
        value: function handleMeasurement() {
            ...
            this.setState({
                ...
                var overlayRect = getRectForNode(_this2.overlay);
                var scrollableContainerRect = getRectForNode(_this2.scrollableContainer);
                ...
                var containerRect = getRectForNode(window);
...
function Pane(_ref) {
    ...
    var className = classNames(styles$41.Pane, fixed && styles$41['Pane-fixed']);
    var content = sectioned ? wrapWithComponent(children, Section$2) : children;
...
var PopoverOverlay = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function render() {
            ...
            var markup = active ? createElement(TransitionGroup.TransitionChild, { render: this.renderOverlay, selector: selector, skipAppearing: true, skipEntering: true }) : null;
            return createElement(
                TransitionGroup,
                null,
                markup
        ...
        value: function renderOverlay(transitionStatus) {
            ...
            return createElement(PositionedOverlay$1, { active: active, activator: activator, preferredPosition: preferredPosition, render: this.renderPopover.bind(this, transitionStatus), onScrollOut: this.handleScrollOut });
        }
    }, {
        key: 'renderPopover',
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = classNames(styles$41.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$41.positionedAbove, measuring && styles$41.measuring);
            var tipMarkup = !measuring ? createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$41.Tip }) : null;
            ...
            return createElement(
                ...
                tipMarkup,
                createElement('div', { className: styles$41.FocusTracker, tabIndex: 0, onFocus: this.handleFocusFirstItem }),
                createElement(
                    'div',
                    { className: styles$41.Wrapper },
                    content
                ),
                createElement('div', { className: styles$41.FocusTracker, tabIndex: 0, onFocus: this.handleFocusLastItem })
            );
        }
    }, {
        key: 'setContentNode',
        ...
        value: function handleClick(event) {
            ...
            if (contentNode != null && nodeContainsDescendant(contentNode, target) || nodeContainsDescendant(activator, target)) {
                return;
            }
...
function Thumbnail$1(_ref) {
    ...
    var className = classNames(styles$42.Thumbnail, size && styles$42[variationName('size', size)]);
    return createElement(
        'span',
        { className: className },
...
var Item$6 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$43.Item, url && styles$43['Item-link'], focused && styles$43['Item-focused'], persistActions && styles$43['Item-persistActions'], mediaType && styles$43[variationName('Item-media', mediaType)], mediaSize && styles$43[variationName('Item-size', mediaSize)]);
...
function renderException(exception, index) {
    ...
    var className = classNames(styles$43.ExceptionItem, status && styles$43[variationName('ExceptionItem-status', status)]);
...
function Labelled$1(_a) {
    ...
    var className = classNames(labelHidden && styles$44.hidden);
    var helpTextMarkup = helpText ? createElement(
        'div',
...
function Select$1(_ref) {
    ...
    var className = classNames(styles$45.Select, error && styles$45.error, disabled && styles$45.disabled, isPlaceholder && styles$45.placeholder);
    ...
    return createElement(
        ...
        createElement(
            ...
            createElement(
                ...
                createElement(Icon$1, { source: arrowIcon })
            ),
...
var Item$8 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$46.Item);
            return createElement(
                'li',
                null,
                createElement(
...
__decorate([autobind], Item$8.prototype, "setFocusedNode", null);
    ...
    _createClass(List, [{
        ...
        value: function render() {
            ...
            var tabs = disclosureTabs.map(function (tab, index) {
                return createElement(Item$8, { key: index + '-' + tab.id, index: index, focusIndex: focusIndex, tab: tab, onClick: onClick.bind(null, tab) });
            });
            return createElement(
                'ul',
...
var Tab = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$46.Tab, selected && styles$46['Tab-selected']);
            var tabIndex = void 0;
        ...
        value: function handleMouseLeave() {
            var firstFocusable = findFirstFocusableNode(this.node);
            if (firstFocusable) {
                firstFocusable.blur();
            }
        }
...
__decorate([autobind], Tab.prototype, "handleMouseLeave", null);
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var tabsMarkup = tabs.map(function (tab, index) {
                return createElement(
                    Tab,
                    { measuring: true, tab: tab, key: '' + index + tab.id + 'Hidden', id: tab.id + 'Measurer', siblingTabHasFocus: siblingTabHasFocus, focused: index === tabToFocus, selected: index === selected, onClick: noop, url: tab.url, panelID: tab.panelID },
                    tab.title
                );
            });
            var classname = classNames(styles$46.Tabs, styles$46.TabMeasurer);
            return createElement(
                'div',
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var classname = classNames(styles$46.Tabs, fitted && styles$46.fitted, disclosureActivatorVisible && styles$46.fillSpace);
            var disclosureTabClassName = classNames(styles$46.DisclosureTab, disclosureActivatorVisible && styles$46['DisclosureTab-visible']);
...
var Item$10 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = classNames(styles$48.Item, focused && styles$48['Item-focused'], position === Position.Primary ? styles$48['Item-primary'] : styles$48['Item-connection']);
            return createElement(
                'div',
...
__decorate([autobind], Item$10.prototype, "handleBlur", null);
__decorate([autobind], Item$10.prototype, "handleFocus", null);
...
var Resizer = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? createElement('div', { ref: this.setMinimumLinesNode, className: styles$49.DummyInput, dangerouslySetInnerHTML: { __html: getContentsForMinimumLines(minimumLines) } }) : null;
            return createElement(
                'div',
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            var _a = this.props,
                ...
                rest = __rest(_a, ["id", "value", "placeholder", "disabled", "readOnly", "autoFocus", "type", "name", "error", "multiline", "connectedRight", "connectedLeft", "label", "labelAction", "labelHidden", "helpText", "prefix", "suffix", "onFocus", "onBlur", "autoComplete"]);var height = this.state.height;

            var className = classNames(styles$49.TextField, Boolean(value) && styles$49.hasValue, disabled && styles$49.disabled, readOnly && styles$49.readOnly, error && styles$49.error, multiline && styles$49.multiline);
            ...
            var spinnerMarkup = type === 'number' ? createElement(Spinner, { onClick: this.handleInputFocus, onChange: this.handleNumberChange }) : null;
...
var TooltipOverlay = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var containerClassName = classNames(styles$50.Tooltip, light && styles$50.light, measuring && styles$50.measuring, positioning === 'above' && styles$50.positionedAbove);
            var contentStyles = measuring ? undefined : { maxHeight: desiredHeight };
            var tipMarkup = !measuring ? createElement('div', { style: tipStyle, className: styles$50.Tip }) : null;
            return createElement(
                'div',
